...
- Собранные релизы проверяют обновления через GitHub Releases ScreenTool. Для аварийного отключения можно запустить приложение с `SCREENTOOL_DISABLE_AUTO_UPDATES=1`.
