...
function PopoverContent({
	...
	const content = (
		<PopoverPrimitive.Content
			...
			className={cn(
				!unstyled &&
					"z-50 w-72 rounded-[var(--radius-panel)] border border-border bg-popover/[0.92] p-4 text-popover-foreground shadow-[0_18px_50px_hsl(var(--shadow-color)/0.18),inset_0_1px_0_hsl(0_0%_100%/0.28)] backdrop-blur-[var(--glass-blur)] outline-hidden",
